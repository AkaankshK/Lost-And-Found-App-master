...
import 'package:search_india/selectProfileLocation/profileSelectLocation.dart';
    ...
    try {
      ...
      for (var doc in data.documents) {
        if (doc.documentID == uid1) {
          ...
          loc = doc.data['img'] != null
              ? doc.data['img']
              : "https://www.stickpng.com/assets/images/585e4beacb11b227491c3399.png";
          break;
        }
      }
      setState(() {
